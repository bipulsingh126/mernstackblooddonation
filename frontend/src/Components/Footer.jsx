    ...
    <div className=" bg-gray-100 px-[200px] h-[60vh] mt-[50px] ">
      <div className="flex justify-between py-[5%]  ">
        ...
        <div className="w-full md:w-1/3 ">
          ...
          <p className="mt-2 ">123 BloodContact kanpur ,city, Uttar Pradesh </p>
          <p className="mt-2 ">Phone : (123) 456-789 </p>
          <p className="mt-2 ">Email: jijowox180@alientex.com </p>
        </div>
      </div>
      <div className="mt-8 border-t border-red-800 pt-4 text-center ">
        <p>&copy; 2024 BloodBridge At nights resverd</p>
